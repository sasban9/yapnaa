...
if ($posts->have_posts()) {
    ...
    <?php if ($view_more) : ?>
        <div class="push-top m-b-xxl text-center">
            <a class="btn btn-primary<?php echo $view_more_class ? ' ' . str_replace('.', '', $view_more_class) : '' ?>" href="<?php echo get_post_type_archive_link( 'faq' ) ?>"><?php _e("View More", 'porto-shortcodes') ?></a>
        </div>
    <?php endif; ?>
