...
$sql = "INSERT INTO Service (mobileNo, brandName, productType, Issue)
VALUES ('$phone' , '$brandname', '$product_type', '$issue' )";
...
$conn->close();
	 ...
	 $ToEmail = 'yusuf.jjbytes@gmail.com';
	  $Message = '<html><body style="font-family: century Gothic;font-size:14px;">'
                ...
                . '</td></tr><tr><td style="width:200px;border: 1px solid grey;padding:2px;">Issue: </td><td style="border: 1px solid grey;max-width:600px;padding:2px;">' . $issue
                . '</td></tr>
