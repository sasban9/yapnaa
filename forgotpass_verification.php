...
require_once(__DIR__.'/'.'movilo/controller/user_controller.php');
	 ...
	 $obj_user = new users;
	if(isset($_POST['d_password']) || !empty($_POST['d_password'])){
		 $obj_user->n_yapnaa_forgot_password_save($user_mobile,$_POST['d_password']);
	}
	?>
			 ...
			 <form action="" method="post" role="form" class="contactForm ">
				...
				<!--div class="row ">
				 ...
				 <div class="row ">
					 ...
					 <div class="col-sm-8 ">
						<div class="inputBox  ss" style="margin-bottom:15px;">
						   <input type="password" name="d_password" placeholder="Password" class="input " required>
						</div>
					 </div>
				 </div>
				 <div class="row ">
					 ...
					 <div class="col-sm-8 ">
						<div class="inputBox ss " >
						   <input type="password" name="d_cpassword" placeholder="Confirm Password" class="input " required>
