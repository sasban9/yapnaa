    ...
    <script>
        $(document).ready(function() {
            setTimeout(function() {
                ...
                toastr.success(admin_name, 'Welcome to Admin Dashboard');
...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.0/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Apr 2015 10:50:36 GMT -->
</html>