				...
				if(is_uploaded_file($_FILES['file']['tmp_name'])){
					...
					while(!feof($csvFile)){
						...
						if($prevResult->num_rows > 0){
							...
							$sql="INSERT INTO zerob_consol1 ( `CUSTOMERID`, `CUSTOMER_NAME`, `CUSTOMER_ADDRESS1`, `CUSTOMER_ADDRESS2`, `CUSTOMER_ADDRESS3`, `CUSTOMER_AREA`, `CUSTOMER_PINCODE`, `PHONE1`, `PHONE2`, `CUSTOMER_CONTACT_NOS1`, `CUSTOMER_CONTACT_NOS2`, `email`, `PRODUCT`, `PRODUCT_SLNO`, `INSTALLATION_DATE`, `IW`, `IC`, `CONTRACT_FROM`, `CONTRACT_TO`, `CONTRACT_TYPE`, `CONTRACT_BY`, `tag`, `amc_updated_by`, `last_called`, `last_call_comment`, `last_sms_sent`, `amc_appointment_datetime`, `status`) VALUES ('".$line[$i][1]."','".$line[$i][2]."','".$line[$i][3]."','".$line[$i][4]."','".$line[$i][5]."','".$line[$i][6]."','".$line[$i][7]."','".$line[$i][8]."','".$line[$i][9]."','".$line[$i][10]."','".$line[$i][11]."','".$line[$i][12]."','".$line[$i][13]."','".$line[$i][14]."','".$line[$i][15]."','".$line[$i][16]."','".$line[$i][17]."','".$line[$i][18]."','".$line[$i][19]."','".$line[$i][20]."','".$line[$i][21]."','".$line[$i][22]."','".$line[$i][23]."','".$line[$i][24]."','".$line[$i][25]."','".$line[$i][26]."','".$line[$i][27]."','".$line[28]."')";
