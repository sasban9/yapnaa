															...
															<div class="tab-content">
																...
																<div class="tab-pane active" id="tab-1"> 
																			...
																			<div class="form-group has-success">
																				...
																				<div class="col-sm-10">
																					<?php echo $get_faq_list[0]['srm_questions'];?>
																				</div>
																			</div>
																			...
																			<div class="form-group has-warning">
																				...
																				<div class="col-sm-10">
																					<?php echo $get_faq_list[0]['srm_question_opt1'];?>
																				</div>
																			</div>
																			...
																			<div class="form-group has-warning">
																				...
																				<div class="col-sm-10">
																					<?php echo $get_faq_list[0]['srm_question_opt2'];?>
																				</div>
																			</div>
																			...
																			<div class="form-group has-warning">
																				...
																				<div class="col-sm-10">
																					<?php echo $get_faq_list[0]['srm_question_opt3'];?>
																				</div>
																			</div>
																			...
																			<div class="form-group has-warning">
																				...
																				<div class="col-sm-10">
																					<?php echo $get_faq_list[0]['srm_question_opt4'];?>	
																				</div>
																			</div>
																			...
																			<div class="form-group has-error"><label class="col-sm-2 control-label">Multi / Single Select:</label>
																				<div class="col-sm-10">
																					<?php echo $get_faq_list[0]['srm_question_type'];?>
																				</div>
																			</div> 
																</div>
															</div>
