                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                             ...
                                             <input type="text" id="ser_name" name="ser_name" placeholder="Name" class="form-control border-input input" required>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <input type="text" id="ser_phone" name="ser_phone"  placeholder="Phone Number" class="form-control border-input input" required>
