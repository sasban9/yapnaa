...
$service_info_status=  $obj_user->service_info();
         ...
         <div class="sidebar" data-background-color="white" data-active-color="danger">
            ...
            <div class="sidebar-wrapper">
               ...
               <ul class="nav">
                  ...
                  <li class="active">
                     <a href="myticket.php">
                         <img style="display:inline-block;" src="assets/img/dashboard/ticket1.svg" alt="Circle Image" height="25" width="25" class=" img-no-padding img-responsive">
                           ...
                           <div class="col-md-12" style="background:#f4f3ef;padding-bottom: 3%;">
							 ...
							 ?>
                                 <div class="col-md-12" style="padding:30px;border-bottom:2px solid #ffff;"> 
									...
									<div class="col-md-6">
									<p><?php echo $service['srm_user_generated_date'];?></p>
									<p><?php echo $service['brand_name'];?></p>
									<p><?php echo $service['product_name'];?></p>
									<p><?php echo ($service['type'])?$service['type']:'&nbsp';?></p>
									<p><?php 
									//0- Open, 1-MVQ Generate, 2-Assigned,3-close
									 switch($service['srm_status']){
							  ...
							  <?php  }
								  ...
								  ?>
								  <label>There is no request submitted</label>
							  <?php }?>
                              </div>
                           </div>
                        </div>
