                           ...
                           <div class="col-md-12" style="background:#f4f3ef;padding-bottom: 3%;">
                              <div class="content" >
                                 ...
                                 <div class="col-md-3">
									...
									<a href="digi-locker-product-details.php?cat=<?php echo $product['p_category_id'];?>&user=<?php echo $dl_user_id;?>"><input type="button" value="view"></a>
									</p>
                                 </div>
				  ...
				  <form action="" method="POST" enctype="multipart/form-data"> 
							 ...
							 <div class="col-md-12"> 
							  <div class="col-md-4">
									...
									<input hidden  type="text" id="dl_product_type_id" style="max-width: 132px" name="dl_product_type_id">
								</div>
							   <div class="col-md-4">
