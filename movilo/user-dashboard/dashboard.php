               ...
               <ul class="nav">
                  ...
                  <li class="active">
                     <a href="dashboard.php">
                       <img style="display:inline-block;" src="assets/img/dashboard/dashboard1.svg" alt="Circle Image" height="25" width="25" class=" img-no-padding img-responsive">
            ...
            <nav class="navbar navbar-default" >
               <div class="container-fluid">
                  <div class="navbar-header">
                     <div class="col-xs-6">
                        <a href="http://www.creative-tim.com" class="simple-text hidden-lg hidden-md">
               ...
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-md-8">
                        ...
                        <div class="card" style="margin-top: 39%;">
                           <div class="col-md-8">
                              <h4 class="title">Add Products</h4>
                           </div>
                           <div class="col-md-4">
                              <h6 class="title allprod pointer " style="float: right;margin-top: 4%;">View all</h6>
                           </div>
                           <div class="col-md-12" style="background:#f4f3ef;padding-bottom: 3%;">
                              <div class="content" >
                                 <?php foreach($produtcat as $product){
									 if($product['p_category_id']==1 || $product['p_category_id']==9 || $product['p_category_id']==3 || $product['p_category_id']==4){?>
                                 <div class="col-md-3">
                                    <div class="avatar">
                                    ...
                                    <h6 onclick="brandList(<?php echo $product['p_category_id'];?>)" class="title pointer text-center" data-toggle="modal" data-target="#myModal"><?php echo $product['p_category_name'];?></h6>
									 ...
									 <?php }else{?>
								<div class="col-md-3 viewall" hidden>
                                    <div class="avatar">
                                       <img onclick="brandList(<?php echo $product['p_category_id'];?>)" data-toggle="modal" src="../product-icon/<?php echo $product['p_category_icon_small'];?>" data-target="#myModal" alt="Circle Image" height="100" width="100" class="pointer img-no-padding img-responsive img-center">
								     </div>
                                    <h6 onclick="brandList(<?php echo $product['p_category_id'];?>)" class="title pointer text-center" data-toggle="modal" data-target="#myModal"><?php echo $product['p_category_name'];?></h6>
