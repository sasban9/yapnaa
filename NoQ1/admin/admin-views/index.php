...
$get_all_product_salecount = $admin_controller->get_all_product_salecount();
$get_all_order_list =  $admin_controller->get_all_order_list();
//print_r($get_all_order_list);
//die();
?>
          ...
          <section class="vbox">          
            <section class="scrollable padder">
              <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li class="active">NOQ</li>
              </ul>
              <div class="m-b-md">
                <h3 class="m-b-none">NOQ</h3>
                <small>Welcome back, <?php echo $_SESSION['ad_name'];?></small>
              </div>
              <section class="panel panel-default">
                <div class="row m-l-none m-r-none bg-light lter">
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong><?php echo $get_all_order_list['total_pcount'];  ?></strong></span>
                  ...
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                      ...
                      <span class="easypiechart pos-abt" data-percent="100" data-line-width="4" data-track-Color="#fff" data-scale-Color="false" data-size="0" data-line-cap='butt' data-animate="2000" data-target="#bugs" ></span>
                    </span>
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="bugs"><?php echo $get_all_product_salecount['total_pcount']; ?></strong></span>
                      <small class="text-muted text-uc">Total Ticket Sold</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">                     
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                      ...
                      <span class="easypiechart pos-abt" data-line-width="4" data-track-Color="#f5f5f5" data-scale-Color="false" data-size="50" data-line-cap='butt' data-animate="3000" data-target="#firers"></span>
                    </span>
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="firers"><?php echo $get_users_yearly_count; ?></strong></span>
                      <small class="text-muted text-uc">No. Of Customers</small>
                    </a>
                  </div>
                  <!--div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    <span class="fa-stack fa-2x pull-left m-r-sm">
               ...
               <section class="panel panel-default">
                <div class="row m-l-none m-r-none bg-light lter">
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong><?php echo $get_users_yearly_count;?></strong></span>
                      <small class="text-muted text-uc">Users count(current year)</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="bugs"><?php echo $get_all_product_salecount['total_pcount']; ?></strong></span>
                      <small class="text-muted text-uc">Products Count</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">                     
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="firers"><?php //echo $get_all_order_list; ?></strong></span>
                      <small class="text-muted text-uc">Orders list</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                ...
                <!--
                  ...
                  <section class="panel panel-default">
                    ...
                    <footer class="panel-footer bg-white no-padder">
                      <div class="row text-center no-gutter">
                        <div class="col-xs-3 b-r b-light">
                          <span class="h4 font-bold m-t block"><?php echo $get_all_order_list['total_pcount'];  ?></span>
                          <small class="text-muted m-b block">Orders</small>
                        </div>
                       <!-- <div class="col-xs-3 b-r b-light">
                          <span class="h4 font-bold m-t block">10,450</span>
                     ...
                     <!--   <div class="col-xs-3 b-r b-light">
                          <span class="h4 font-bold m-t block"><?php echo $get_all_product_salecount['total_pcount']; ?></span>
                          <small class="text-muted m-b block">Products</small>
                        </div>
                        <div class="col-xs-3">
                          <span class="h4 font-bold m-t block"><?php echo $get_users_yearly_count; ?></span>
                          <small class="text-muted m-b block">Users</small>                        
                        </div>
                      </div>
                    </footer>
                  </section>
