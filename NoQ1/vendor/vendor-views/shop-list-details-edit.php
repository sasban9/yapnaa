...
{   
	$update_business_store	=	$vendor_controller->update_business_store();  
				 ...
				 <section class="panel panel-default" id="progressbar">
                    <header class="panel-heading"> 
                      <ul class="nav nav-tabs"> 
						...
						<img src="../../admin/admin-views/images/business_stores/<?php echo $get_store_details_by_id[0]['b_store_image'];?>" width="50px" height="50px" />
