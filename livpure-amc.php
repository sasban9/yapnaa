...
.freebirdFormviewerViewFormCard:first-of-type {
	...
	.freebirdThemedFlatButton .exportInk {
		background-image: radial-gradient( circle farthest-side, rgba(103, 58, 183, 0.15), rgba(103, 58, 183, 0.15) 80%, rgba(103, 58, 183, 0) 100%);
	}
	...
	.freebirdUltraLightBackgrouand {
		background-color: rgba(237, 231, 246, 0.25);
	}
	...
	.freebirdForegroundFill {
	 ...
	 @media (max-width: 768px) {
	  ...
	  @media (min-width: 768px) { 
		...
		.banner-livpure{
			background-image: url(img/Livpure-banner.jpg); 
			width: 100%;
			height: 524px;			
...
.img-center{
  display: block;
   ...
   .btn-primary {
    color: #fff !important;
    background-color: #1d8ceb !important;
    border-color: #1d8ceb !important;
}
 ...
 require_once(__DIR__.'/'.'movilo/controller/user_controller.php');
	 ...
	 $obj_user = new users;
	if(isset($_POST['d_name']) || isset($_POST['m_name'])){
		$name=(!empty($_POST['d_name']))?$_POST['d_name']:$_POST['m_name'];
	}
	if(isset($_POST['d_phone_number']) || isset($_POST['m_phone_number'])){
		$phone_number=(!empty($_POST['d_phone_number']))?$_POST['d_phone_number']:$_POST['m_phone_number'];
	}
	if(isset($_POST['d_email_id']) || isset($_POST['m_email_id'])){
		$email_id=(!empty($_POST['d_email_id']))?$_POST['d_email_id']:$_POST['m_email_id'];
	}
	   if(!empty($name) && !empty($phone_number) && !empty($email_id)){
		   //echo "here";
		 $obj_user->amc_landing_request($name,$phone_number,$email_id);
	   }
...
<div class="col-lg-12">
<header>
<title>Livpure AMC</title>
 <link rel="shortcut icon" href="../images/yapnaa-fav.png" type="image/x-icon">
<div class="col-lg-2">
<img src="img/Livpure-logo.jpg" class="liv-logo"  role="img" aria-hidden="true" >                                    
</div>
<div class="col-lg-5">
</div>
<div class="col-lg-5">
...
<div class="col-lg-12 banner-livpure" style=" ">
...
<div class="col-lg-7 desktop" >
									...
									<div class="freebirdFormviewerViewCenteredContent" >
												<form    method="POST" id="livpureformId">
													<div class="freebirdFormviewerViewFormCard " >
														...
														<div class="freebirdFormviewerViewFormContent ">
															...
															<div class="freebirdFormviewerViewItemList" role="list">
																<div role="listitem" class="freebirdFormviewerViewItemsItemItem freebirdFormviewerViewItemsTextTextItem" jsname="ibnC6b" jscontroller="rDGJeb" jsaction="sPvj8e:e4JwSe,vwKRrd;" data-item-id="1794309764">
																	<div class="freebirdFormviewerViewItemsItemItemHeader">
																		<div class="freebirdFormviewerViewItemsItemItemTitleContainer">
																			<div class="freebirdFormviewerViewItemsItemItemTitle freebirdCustomFont" dir="auto" role="heading" aria-level="2" aria-describedby="i.desc.1794309764">Name</div>
																			<div class="freebirdFormviewerViewItemsItemItemHelpText" id="i.desc.1794309764" dir="auto"></div>
																		</div>
																	</div>
																			...
																			<div class="quantumWizTextinputPaperinputMainContent exportContent">
																				<div class="quantumWizTextinputPaperinputContentArea exportContentArea">
																					<div class="quantumWizTextinputPaperinputInputArea">
																						<input type="text" placeholder="Your Name" name="d_name" class="quantumWizTextinputPaperinputInput exportInput" jsname="YPqjbf" autocomplete="off" tabindex="0" aria-label="Name" aria-describedby="i.desc.1794309764 i.err.1794309764" name="" value="" dir="auto" data-initial-dir="auto" data-initial-value="" required />
																	...
																	<div jsname="XbIQze" class="freebirdFormviewerViewItemsItemErrorMessage" id="i.err.1794309764" role="alert"></div>
																</div>
																<div role="listitem" class="freebirdFormviewerViewItemsItemItem freebirdFormviewerViewItemsTextTextItem" jsname="ibnC6b" jscontroller="rDGJeb" jsaction="sPvj8e:e4JwSe,vwKRrd;" data-item-id="1794309764">
																	<div class="freebirdFormviewerViewItemsItemItemHeader">
																		<div class="freebirdFormviewerViewItemsItemItemTitleContainer">
																			<div class="freebirdFormviewerViewItemsItemItemTitle freebirdCustomFont" dir="auto" role="heading" aria-level="2" aria-describedby="i.desc.1794309764">Phone Number</div>
																			<div class="freebirdFormviewerViewItemsItemItemHelpText" id="i.desc.1794309764" dir="auto"></div>
																		</div>
																	</div>
																	<div class="freebirdFormviewerViewItemsTextItemWrapper">
																		<div class="quantumWizTextinputPaperinputEl freebirdFormviewerViewItemsTextShortText freebirdThemedInput modeLight" jscontroller="pxq3x" jsaction="clickonly:KjsqPd; focus:Jt1EX; blur:fpfTEe; input:Lg5SV;" jsshadow jsname="W85ice">
																			<div class="quantumWizTextinputPaperinputMainContent exportContent">
																				<div class="quantumWizTextinputPaperinputContentArea exportContentArea">
																					<div class="quantumWizTextinputPaperinputInputArea">
																						<input type="number" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" onKeyDown="if(this.value.length==10 && event.keyCode!=8) return false;" placeholder="Your Phone Number" name="d_phone_number" class="quantumWizTextinputPaperinputInput exportInput" jsname="YPqjbf" autocomplete="off" tabindex="0" aria-label="Phone" aria-describedby="i.desc.1794309764 i.err.1794309764" name="" value="" dir="auto" data-initial-dir="auto" data-initial-value="" required />
																...
																<div role="listitem" class="freebirdFormviewerViewItemsItemItem freebirdFormviewerViewItemsTextTextItem" jsname="ibnC6b" jscontroller="rDGJeb" jsaction="sPvj8e:e4JwSe,vwKRrd;" data-item-id="1786426569">
																	<div class="freebirdFormviewerViewItemsItemItemHeader">
																		<div class="freebirdFormviewerViewItemsItemItemTitleContainer">
																			<div class="freebirdFormviewerViewItemsItemItemTitle freebirdCustomFont" dir="auto" role="heading" aria-level="2" aria-describedby="i.desc.1786426569">Email ID</div>
																			<div class="freebirdFormviewerViewItemsItemItemHelpText" id="i.desc.1786426569" dir="auto"></div>
																		</div>
																	</div>
																	<div class="freebirdFormviewerViewItemsTextItemWrapper">
																		<div class="quantumWizTextinputPaperinputEl freebirdFormviewerViewItemsTextShortText freebirdThemedInput modeLight" jscontroller="pxq3x" jsaction="clickonly:KjsqPd; focus:Jt1EX; blur:fpfTEe; input:Lg5SV;" jsshadow jsname="W85ice">
																			<div class="quantumWizTextinputPaperinputMainContent exportContent">
																				<div class="quantumWizTextinputPaperinputContentArea exportContentArea">
																					<div class="quantumWizTextinputPaperinputInputArea">
																						<input type="email" placeholder="Your Email ID" name="d_email_id" class="quantumWizTextinputPaperinputInput exportInput" jsname="YPqjbf" autocomplete="off" tabindex="0" aria-label="Email ID" aria-describedby="i.desc.1786426569 i.err.1786426569" name="entry.1388058529" value="" dir="auto" data-initial-dir="auto" data-initial-value="" required />
																						</div>
																					<div class="quantumWizTextinputPaperinputUnderline exportUnderline"></div>
																					<div jsname="XmnwAc" class="quantumWizTextinputPaperinputFocusUnderline exportFocusUnderline"></div>
																				</div>
																	...
																	<div class="freebirdFormviewerViewItemsItemGradingGradingBox freebirdFormviewerViewItemsItemGradingFeedbackBox" jsname="R7fTud"></div>
																	<div jsname="XbIQze" class="freebirdFormviewerViewItemsItemErrorMessage" id="i.err.1786426569" role="alert"></div>
																</div>
															</div>
															<div class="freebirdFormviewerViewNavigationNavControls" jscontroller="lSvzH" jsaction="rcuQ6b:npT2md;JIbuQc:Gl574d(QR6bsb),V3upec(GeGHKb),HiUbje(M2UYVd),NPBnCf(OCpkoe);" data-shuffle-seed="-3997568648481543389" data-should-execute-invisible-captcha-challenge="false" data-is-receipt-checked="false">
																<div class="freebirdFormviewerViewNavigationButtonsAndProgress">
																	<div class="freebirdFormviewerViewNavigationButtons">
																		<div role="button" class="quantumWizButtonPaperbuttonEl quantumWizButtonPaperbuttonFlat quantumWizButtonPaperbuttonDark quantumWizButtonPaperbutton2El2 freebirdFormviewerViewNavigationSubmitButton" jscontroller="VXdfxd" jsaction="click:cOuCgd; mousedown:UX7yZ; mouseup:lbsD7e; mouseenter:tfO1Yc; mouseleave:JywGue;touchstart:p6p2H; touchmove:FwuNnf; touchend:yfqBxc(preventMouseEvents=true|preventDefault=true); touchcancel:JMtRjd;focus:AHmuwe; blur:O22p3e; contextmenu:mg9Pef;" jsshadow jsname="M2UYVd" aria-disabled="false" tabindex="0">
																			...
																			<input type="submit"   class="quantumWizButtonPaperbuttonContent btn btn-primary footer-btn mb-2" style="min-width:125px !important; text-transform: uppercase;font-size: 14px;font-weight: 500;" value="Request AMC">
																			</div>
																	</div>
																</div>
																	...
																	<div class="freebirdFormviewerViewItemsTextItemWrapper">
																		<div class="quantumWizTextinputPaperinputEl freebirdFormviewerViewItemsTextShortText freebirdThemedInput modeLight" jscontroller="pxq3x" jsaction="clickonly:KjsqPd; focus:Jt1EX; blur:fpfTEe; input:Lg5SV;" jsshadow jsname="W85ice">
																			<div class="quantumWizTextinputPaperinputMainContent exportContent">
																				<div class="quantumWizTextinputPaperinputContentArea exportContentArea">
																					<div class="quantumWizTextinputPaperinputInputArea">
																						<input type="text" name="m_name" placeholder="Your Name" class="quantumWizTextinputPaperinputInput exportInput" jsname="YPqjbf" autocomplete="off" tabindex="0" aria-label="Name" aria-describedby="i.desc.1794309764 i.err.1794309764" name="" value="" dir="auto" data-initial-dir="auto" data-initial-value="" required />
																	...
																	<div class="freebirdFormviewerViewItemsTextItemWrapper">
																		<div class="quantumWizTextinputPaperinputEl freebirdFormviewerViewItemsTextShortText freebirdThemedInput modeLight" jscontroller="pxq3x" jsaction="clickonly:KjsqPd; focus:Jt1EX; blur:fpfTEe; input:Lg5SV;" jsshadow jsname="W85ice">
																			<div class="quantumWizTextinputPaperinputMainContent exportContent">
																				<div class="quantumWizTextinputPaperinputContentArea exportContentArea">
																					<div class="quantumWizTextinputPaperinputInputArea">
																						<input type="number" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" onKeyDown="if(this.value.length==10 && event.keyCode!=8) return false;" name="m_phone_number" placeholder="Your Phone Number" class="quantumWizTextinputPaperinputInput exportInput" jsname="YPqjbf" autocomplete="off" tabindex="0" aria-label="Phone" aria-describedby="i.desc.1794309764 i.err.1794309764" name="" value="" dir="auto" data-initial-dir="auto" data-initial-value="" required />
																	...
																	<div class="freebirdFormviewerViewItemsTextItemWrapper">
																		<div class="quantumWizTextinputPaperinputEl freebirdFormviewerViewItemsTextShortText freebirdThemedInput modeLight" jscontroller="pxq3x" jsaction="clickonly:KjsqPd; focus:Jt1EX; blur:fpfTEe; input:Lg5SV;" jsshadow jsname="W85ice">
																			<div class="quantumWizTextinputPaperinputMainContent exportContent">
																				<div class="quantumWizTextinputPaperinputContentArea exportContentArea">
																					<div class="quantumWizTextinputPaperinputInputArea">
																						<input type="email" name="m_email_id" placeholder="Your Email ID" class="quantumWizTextinputPaperinputInput exportInput" jsname="YPqjbf" autocomplete="off" tabindex="0" aria-label="Email ID" aria-describedby="i.desc.1786426569 i.err.1786426569" name="entry.1388058529" value="" dir="auto" data-initial-dir="auto" data-initial-value="" required />
																						</div>
																					<div class="quantumWizTextinputPaperinputUnderline exportUnderline"></div>
																					<div jsname="XmnwAc" class="quantumWizTextinputPaperinputFocusUnderline exportFocusUnderline"></div>
																				</div>
                                ...
                                <div class="col-md-9">
                                    <div class="LS81yb VICjCf" >
                                        <div class="hJDwNd-AhqUyc-uQSCkd purZT-AhqUyc-II5mzb pSzOP-AhqUyc-qWD73c JNdkSc " >
                                            <div class="oKdM2c">
                                                <div id="h.p_WI6-OuGnqHxa" class="hJDwNd-AhqUyc-uQSCkd jXK9ad D2fZ2 OjCsFc wHaque">
                                                    <div class="jXK9ad-SmKAyb jXK9ad-SmKAyb-c4YZDc">
                                                        <div class="tyJCtd mGzaTb baZpAe">
                                                            <h2 id="h.p_v3RrrbNqqHxi" class="zfr3Q JYVBee" style="text-align: left;margin-top: 42px;">Benefits of Livpure annual maintenance</h2>
                                                            <!--h3 id="h.p_v3RrrbNqqHxi" class="zfr3Q JYVBee" style="text-align: left;margin-top: 42px;">Experience the benefits of pure water with Livpure annual maintenance</h3-->
                                                            <!--h4 id="h.p_v3RrrbNqqHxi" class="zfr3Q JYVBee" style="text-align: left;margin-top: 42px;">Experience the benefits of pure water with Livpure annual maintenance</h4-->
															<br><br>
                                                            <ul class="n8H08c UVNKR" style="text-align: left;">
                                                                <li id="h.p_xtZJJ2y5qeQF" class="zfr3Q TYR86d">Ensures uninterrupted supply of Pure &amp; Safe Water</li>
                                                                <br>
																<li id="h.p_stS52m6SqiLf" class="zfr3Q TYR86d">Periodic Maintenance, Cleaning of Filters, Replacement of Consumables to avoid Break-down.</li>
                                                                <br>
																<li id="h.p_u4Fb38d5qiLh" class="zfr3Q TYR86d">Comprehensive warranty</li>
                                                                <br>
																<li id="h.p_bcR6fYi6qiLj" class="zfr3Q TYR86d">No Service Charges for any Break-Down Spare Parts</li>
                                                                <br>
																<li id="h.p_3P9zeEhtqiLk" class="zfr3Q TYR86d">Assurance of genuine Livpure Spare Parts</li>
                                                                <br>
																<li id="h.p_Z4_reIm4qiLm" class="zfr3Q TYR86d">Free Replacement of Electrical/Electronic Parts in case of Failure</li>
                                                                <br>
																<li id="h.p_pE5RwHyuqiLo" class="zfr3Q TYR86d">Service by Verified, Certified &amp; Trained Company Engineers</li>
								 ...
								 <div class="row">
								  <div class="col-lg-12" style="background-color: #80808036;">
									<div class="col-md-1"></div>
									<div class="col-md-9">							   
									<section id="h.p_4SmDQahHk5JD" class="yaqOZd qeLZfd" style="padding-bottom: 36px;padding-top: 32px;">
									   <div class="yaqOZd IFuOkc"></div><div class="mYVXT">
									      <div class="LS81yb VICjCf" tabindex="-1">
										    <div class="hJDwNd-AhqUyc-uQSCkd purZT-AhqUyc-II5mzb pSzOP-AhqUyc-qWD73c JNdkSc">
											   <div class="oKdM2c"><div id="h.p_ANoiRGw_k5JM" class="hJDwNd-AhqUyc-uQSCkd jXK9ad D2fZ2 OjCsFc wHaque GNzUNc">
											      <div class="jXK9ad-SmKAyb jXK9ad-SmKAyb-c4YZDc">
												    <div class="tyJCtd mGzaTb baZpAe">
													 <!--p id="h.p_F10Hheq2k5Jc" class="zfr3Q" style="text-align: left;">
													  <strong><u style="font-size: 30px;">One Year ACMC Warranty Details</u></strong>
													  
													  </p-->
													   <h2 id="h.p_v3RrrbNqqHxi" class="zfr3Q JYVBee" style="text-align: left;margin-top: 42px;">One Year ACMC Warranty Details</h2>
                                                           
													  <br><br>
													  <ul class="n8H08c UVNKR" style="text-align: left;">
													  <!--li id="h.p_r6KK8DVdk5Jd" class="zfr3Q TYR86d">Rs 3500 per year applicable for unit purchased on or before December 2015</li>
													   <br-->
													  <li id="h.p_r6KK8DVdk5Jd" class="zfr3Q TYR86d">While taking ACMC, engineer will replace SEDIMENT, CARBON, PRE Filter – free of cost if ACMC taken </li>
													   <br>
													  <li id="h.p_snxbGcsvk5Jf" class="zfr3Q TYR86d">1 more set of Sediment &amp; Carbon will be replaced after 6 Months </li>
													   <br>
													  <li id="h.p_CBgZbS_mk5Ji" class="zfr3Q TYR86d">Beyond 2 sets of filter ( 1 at time of taking ACMC &amp; Other after 6 months) will be charged. Rates given below </li>
                                                       <br>
													  <li id="h.p_aLxxuTGOk5Jj" class="zfr3Q TYR86d">If RO membrane is found defective while taking ACMC, then it will be charged @ 20% discount before taking ACMC </li>
													    <br>
													  <li id="h.p_l8vEs9nhk5Jq" class="zfr3Q TYR86d">3 preventive maintenance will be given, 1<sup>st</sup> while taking ACMC, 2<sup>nd</sup> after 220 days of taking ACMC, 3<sup>rd</sup> after 330 days of taking ACMC </li>
													  </ul>
									...
									<!--div class="col-lg-12">
										<div class="col-lg-3"></div>
											<div class="col-lg-6"-->
											<iframe width="560" height="315" class="img-center"  src="video/ACMC.mp4">
                                             </iframe>
			             ...
			             <footer style="border: 1px solid #33333314;padding:20px">
						 <div class="row " style="" ><a href="https://www.yapnaa.com" target="_balnk"><img src="/img/Yapnaa-logo.svg"  class="img-responsive img-center" height="70" width="70"></a></div>
						 <div class="row" style="text-align:center"><h3>Yapnaa-Your After Sales Companion</h3></div>
						 <div class="row" style="text-align:center">Yapnaa provides the flexibility to manage the key aspects of service and support with brands.</div>
                         <div class="row" style="text-align:center"><a href="https://www.yapnaa.com" style="color:#ff6010;" target="_balnk">www.yapnaa.com</a></div><!--</div>-->
						   ...
						   <div class="col-lg-4">
						           <div >
									...
									<div>
									  <strong>Copyright</strong>  <small>© 2018 <a href="#" target="_balnk">Movilo Networks Pvt. Ltd</a>. All Rights Reserved.</small>
									</div>
								</div-->
                        </footer>
...
<script>
$('.quantumWizButtonPaperbuttonLabel').click(function() {
var d_name=$('#d_name').val();
var d_phone_number=$('#d_phone_number').val();
var d_email_id=$('#d_email_id').val();
var m_name=$('#m_name').val();
var m_phone_number=$('#m_phone_number').val();
var m_email_id=$('#m_email_id').val();
if(d_name=='' && m_name==''){
	alert('Please fill your name !')
}
else if(d_name=='' && m_name==''){
